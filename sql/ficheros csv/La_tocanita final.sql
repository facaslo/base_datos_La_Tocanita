...
CREATE TABLE IF NOT EXISTS produccion_insumos_daily (
  cdp_fecha DATE NOT NULL,
  prd_id TINYINT NOT NULL,
  ins_codigo TINYINT NOT NULL,
  ipd_cantidadinsumo SMALLINT NOT NULL,
...
-- -----------------------------------------------------
-- Tabla produccion_trabajador_daily
-- -----------------------------------------------------
...
LOAD DATA LOCAL INFILE './Proveedores.csv'
INTO TABLE proveedor
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
-- Warnings debidos a entradas duplicadas

LOAD DATA LOCAL INFILE './Compra.csv'
INTO TABLE compra
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(com_idrecibo, prv_nit, @com_fecha)
SET com_fecha = STR_TO_DATE(@com_fecha, '%d/%m/%Y');

LOAD DATA LOCAL INFILE './Insumos.csv'
INTO TABLE insumo
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE './Compra_insumos.csv'
INTO TABLE compra_insumos
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE './CostoProduccionDiaria.csv'
INTO TABLE produccion
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(@cdp_fecha,cdp_costoProduccion)
SET cdp_fecha = STR_TO_DATE(@cdp_fecha, '%d/%m/%Y');

LOAD DATA LOCAL INFILE './Cargo.csv'
INTO TABLE cargo
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE './Trabajador.csv'
INTO TABLE trabajador
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(tra_id, tra_nombre, tra_telefono, tra_correo, tra_titulacion, @tra_fechaContratacion, @tra_fechaDesvinculacion, tra_tipoContrato, cargo_car_id) 
SET tra_fechaContratacion = STR_TO_DATE(@tra_fechaContratacion, '%d/%m/%Y'),
tra_fechaDesvinculacion = STR_TO_DATE(@tra_fechaDesvinculacion, '%d/%m/%Y');

LOAD DATA LOCAL INFILE './Nomina.csv'
INTO TABLE nomina
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(@nom_fecha,nom_periodo,tra_id,nom_descuentos,nom_tipoCuenta,nom_numeroCuenta,nom_valorPago)
SET nom_fecha = STR_TO_DATE(@nom_fecha, '%d/%m/%Y');
...
LOAD DATA LOCAL INFILE './Cliente.csv'
INTO TABLE cliente
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE './Cargamento.csv'
INTO TABLE cargamento
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(crg_id,@crg_fecha,crg_placafurgon)
SET crg_fecha = STR_TO_DATE(@crg_fecha, '%d/%m/%Y');

LOAD DATA LOCAL INFILE './Geografia.csv'
INTO TABLE geografia
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;

LOAD DATA LOCAL INFILE './Venta.csv'
INTO TABLE venta
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(vnt_id,cli_id,geo_codigoPostal,crg_id,vnt_direccion,@vnt_fecha,vnt_estado)
SET vnt_fecha =  STR_TO_DATE(@vnt_fecha, '%d/%m/%Y');

LOAD DATA LOCAL INFILE './InsumosProduccionDiaria.csv'
INTO TABLE produccion_insumos_daily
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(@cdp_fecha,prd_id,ins_codigo,ipd_cantidadinsumo)
SET cdp_fecha =  STR_TO_DATE(@cdp_fecha, '%d/%m/%Y');

LOAD DATA LOCAL INFILE './TrabajadoresProduccionDiaria.csv'
INTO TABLE produccion_trabajador_daily
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(@cdp_fecha,tra_id)
...
LOAD DATA LOCAL INFILE './ResultadoProduccionDiaria.csv'
INTO TABLE resultado_produccion_daily
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(@cdp_fecha,prd_id, rpd_cantidadProducida)
SET cdp_fecha =  STR_TO_DATE(@cdp_fecha, '%d/%m/%Y');

LOAD DATA LOCAL INFILE './Venta_de_productos.csv'
INTO TABLE venta_productos
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
-- Entradas duplicadas
